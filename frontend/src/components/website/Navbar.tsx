            ...
            <div className="hidden md:flex space-x-8">
              {navLinks?.map((link, index) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-white font-medium transition-colors duration-300 hover:border-b-2 hover:border-indigo-500 pb-1${
